...
//                          
//                            let pushAndPageData = PushToSupabase(token: token, page_data: row, page_id: pageID, content_hash: hashContent) //re-add: page_title: SendTitle.shareTitle.displayTitle,
